    ...
    .then(function (htmlString) {
      ...
      rp('https://playoverwatch.com/en-us/search/account-by-name/' + tag)
        .then(function (htmlString) {
          ...
          return next(null, {
            data: { username: username, level: profile.level, games: { quick: { wins: gamesWon.quick, lost: lost.quick, played: gamesPlayed.quick }, competitive: { wins: gamesWon.comp, lost: lost.comp, played: gamesPlayed.comp } }, playtime: { quick: timeplayed.quick, competitive: timeplayed.comp }, avatar: profile.portrait, competitive: { rank: competitiveRank, rank_img: competitiveRankImg }, levelFrame: levelFrame, star: star }
          })
        })
    }).catch(function () {
